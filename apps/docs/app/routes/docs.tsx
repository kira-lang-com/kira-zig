        ...
        footer: (
          <div className="flex flex-col gap-3 w-full">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-fd-muted-foreground hover:text-fd-foreground transition-colors"
            >
