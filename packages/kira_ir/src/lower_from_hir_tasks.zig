...
pub fn lowerTaskSpawn(lowerer: *Lowerer, instructions: *std.array_list.Managed(ir.Instruction), node: model.hir.TaskSpawnExpr) !u32 {
...
pub fn lowerTaskSpawnReady(lowerer: *Lowerer, instructions: *std.array_list.Managed(ir.Instruction), node: model.hir.TaskSpawnReadyExpr) !u32 {
...
pub fn lowerTaskAwait(lowerer: *Lowerer, instructions: *std.array_list.Managed(ir.Instruction), node: model.hir.TaskAwaitExpr) !u32 {
...
/// unused result slot.
pub fn lowerTaskCancel(lowerer: *Lowerer, instructions: *std.array_list.Managed(ir.Instruction), node: model.hir.TaskCancelExpr) !u32 {
    const task_reg = try lowerer.lowerExpr(instructions, node.task);
...
pub fn lowerTaskDetach(lowerer: *Lowerer, instructions: *std.array_list.Managed(ir.Instruction), node: model.hir.TaskDetachExpr) !u32 {
    const task_reg = try lowerer.lowerExpr(instructions, node.task);
