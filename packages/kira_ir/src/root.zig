...
pub const StringFromScalar = ir.StringFromScalar;
pub const StringFromScalarSource = ir.StringFromScalarSource;
pub const StringCharAt = ir.StringCharAt;
pub const StringSubstring = ir.StringSubstring;
pub const StringIndexOf = ir.StringIndexOf;
