...
pub const setProgressCallback = @import("pipeline_timing.zig").setProgressCallback;
pub const progressActive = @import("pipeline_timing.zig").progressActive;
pub const emitProgress = @import("pipeline_timing.zig").emitProgress;
pub const progressPrint = @import("pipeline_timing.zig").progressPrint;
...
test {
    ...
    _ = @import("synth_test_driver_tests.zig");
