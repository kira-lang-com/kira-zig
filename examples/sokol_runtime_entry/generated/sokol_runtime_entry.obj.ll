...
%t.app_state = type { %t.sg_shader, %t.sg_pipeline, i32, i32, i32 }
...
@kira_str_1_data = private unnamed_addr constant [387 x i8] c"#version 330\0D\0Aout vec4 color;\0D\0Aconst vec2 positions[3] = vec2[3](\0D\0A    vec2(0.0, 0.48),\0D\0A    vec2(0.52, -0.52),\0D\0A    vec2(-0.52, -0.52)\0D\0A);\0D\0Aconst vec4 colors[3] = vec4[3](\0D\0A    vec4(1.0, 0.85, 0.15, 1.0),\0D\0A    vec4(0.15, 0.95, 0.85, 1.0),\0D\0A    vec4(0.85, 0.25, 1.0, 1.0)\0D\0A);\0D\0Avoid main() {\0D\0A    gl_Position = vec4(positions[gl_VertexID], 0.0, 1.0);\0D\0A    color = colors[gl_VertexID];\0D\0A}\00"

@kira_str_1 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([387 x i8], ptr @kira_str_1_data, i64 0, i64 0), i64 386 }
...
entry:
  ...
  %field.ptr.8 = getelementptr inbounds %t.app_state, ptr %field.base.8, i32 0, i32 4
  ...
  %r9 = ptrtoint ptr @"kira_fn_1_init" to i64
  %r10 = ptrtoint ptr %local1 to i64
  %field.base.11 = inttoptr i64 %r10 to ptr
  %field.ptr.11 = getelementptr inbounds %t.sapp_desc, ptr %field.base.11, i32 0, i32 5
  ...
  %r12 = ptrtoint ptr @"kira_fn_2_frame" to i64
  ...
  %field.ptr.17 = getelementptr inbounds %t.sapp_desc, ptr %field.base.17, i32 0, i32 7
  ...
  %r18 = ptrtoint ptr @"kira_fn_3_event" to i64
  ...
  %r21 = ptrtoint ptr %local0 to i64
  %r22 = ptrtoint ptr %local1 to i64
  %field.base.23 = inttoptr i64 %r22 to ptr
  %field.ptr.23 = getelementptr inbounds %t.sapp_desc, ptr %field.base.23, i32 0, i32 4
  ...
  %field.ptr.26 = getelementptr inbounds %t.sapp_desc, ptr %field.base.26, i32 0, i32 9
  ...
  %field.ptr.29 = getelementptr inbounds %t.sapp_desc, ptr %field.base.29, i32 0, i32 10
  ...
  %r30 = load %kira.string, ptr @kira_str_0
  %r31 = ptrtoint ptr %local1 to i64
  %field.base.32 = inttoptr i64 %r31 to ptr
  %field.ptr.32 = getelementptr inbounds %t.sapp_desc, ptr %field.base.32, i32 0, i32 16
  ...
  %r33 = ptrtoint ptr %local1 to i64
  %call.arg.44.0 = inttoptr i64 %r33 to ptr
...
entry:
  ...
  %call.struct.1 = call %t.sg_environment @"sglue_environment"()
  %call.ret.ptr.1 = alloca %t.sg_environment
  store %t.sg_environment %call.struct.1, ptr %call.ret.ptr.1
  %r1 = ptrtoint ptr %call.ret.ptr.1 to i64
  %r2 = ptrtoint ptr %local2 to i64
  %field.base.3 = inttoptr i64 %r2 to ptr
  %field.ptr.3 = getelementptr inbounds %t.sg_desc, ptr %field.base.3, i32 0, i32 17
  %r3 = ptrtoint ptr %field.ptr.3 to i64
  %copy.dst.3 = inttoptr i64 %r3 to ptr
  %copy.src.1 = inttoptr i64 %r1 to ptr
  %copy.val.3 = load %t.sg_environment, ptr %copy.src.1
  store %t.sg_environment %copy.val.3, ptr %copy.dst.3
  %r4 = ptrtoint ptr %local2 to i64
  %call.arg.188.0 = inttoptr i64 %r4 to ptr
  call void @"sg_setup"(ptr %call.arg.188.0)
  %r5 = load %kira.string, ptr @kira_str_1
  %r6 = ptrtoint ptr %local3 to i64
  %field.base.7 = inttoptr i64 %r6 to ptr
  %field.ptr.7 = getelementptr inbounds %t.sg_shader_desc, ptr %field.base.7, i32 0, i32 1
  %r7 = ptrtoint ptr %field.ptr.7 to i64
  %field.base.8 = inttoptr i64 %r7 to ptr
  %field.ptr.8 = getelementptr inbounds %t.sg_shader_function, ptr %field.base.8, i32 0, i32 0
  %r8 = ptrtoint ptr %field.ptr.8 to i64
  %store.ptr.5 = inttoptr i64 %r8 to ptr
  %store.cstr.5 = extractvalue %kira.string %r5, 0
  store ptr %store.cstr.5, ptr %store.ptr.5
  %r9 = load %kira.string, ptr @kira_str_2
  %r10 = ptrtoint ptr %local3 to i64
  %field.base.11 = inttoptr i64 %r10 to ptr
  %field.ptr.11 = getelementptr inbounds %t.sg_shader_desc, ptr %field.base.11, i32 0, i32 2
  %r11 = ptrtoint ptr %field.ptr.11 to i64
  %field.base.12 = inttoptr i64 %r11 to ptr
  %field.ptr.12 = getelementptr inbounds %t.sg_shader_function, ptr %field.base.12, i32 0, i32 0
  %r12 = ptrtoint ptr %field.ptr.12 to i64
  %store.ptr.9 = inttoptr i64 %r12 to ptr
  %store.cstr.9 = extractvalue %kira.string %r9, 0
  store ptr %store.cstr.9, ptr %store.ptr.9
  %r13 = ptrtoint ptr %local3 to i64
  %call.arg.126.0 = inttoptr i64 %r13 to ptr
  %call.struct.14 = call %t.sg_shader @"sg_make_shader"(ptr %call.arg.126.0)
  %call.ret.ptr.14 = alloca %t.sg_shader
  store %t.sg_shader %call.struct.14, ptr %call.ret.ptr.14
  %r14 = ptrtoint ptr %call.ret.ptr.14 to i64
  %r15 = load i64, ptr %local1
  %field.base.16 = inttoptr i64 %r15 to ptr
  %field.ptr.16 = getelementptr inbounds %t.app_state, ptr %field.base.16, i32 0, i32 0
  %r16 = ptrtoint ptr %field.ptr.16 to i64
  %copy.dst.16 = inttoptr i64 %r16 to ptr
  %copy.src.14 = inttoptr i64 %r14 to ptr
  %copy.val.16 = load %t.sg_shader, ptr %copy.src.14
  store %t.sg_shader %copy.val.16, ptr %copy.dst.16
  %r17 = load i64, ptr %local1
  %field.base.18 = inttoptr i64 %r17 to ptr
  %field.ptr.18 = getelementptr inbounds %t.app_state, ptr %field.base.18, i32 0, i32 0
  %r18 = ptrtoint ptr %field.ptr.18 to i64
  %r19 = ptrtoint ptr %local4 to i64
  %field.base.20 = inttoptr i64 %r19 to ptr
  %field.ptr.20 = getelementptr inbounds %t.sg_pipeline_desc, ptr %field.base.20, i32 0, i32 2
  %r20 = ptrtoint ptr %field.ptr.20 to i64
  %copy.dst.20 = inttoptr i64 %r20 to ptr
  %copy.src.18 = inttoptr i64 %r18 to ptr
  %copy.val.20 = load %t.sg_shader, ptr %copy.src.18
  store %t.sg_shader %copy.val.20, ptr %copy.dst.20
  %r21 = ptrtoint ptr %local4 to i64
  %call.arg.124.0 = inttoptr i64 %r21 to ptr
  %call.struct.22 = call %t.sg_pipeline @"sg_make_pipeline"(ptr %call.arg.124.0)
  %call.ret.ptr.22 = alloca %t.sg_pipeline
  store %t.sg_pipeline %call.struct.22, ptr %call.ret.ptr.22
  %r22 = ptrtoint ptr %call.ret.ptr.22 to i64
  %r23 = load i64, ptr %local1
  %field.base.24 = inttoptr i64 %r23 to ptr
  %field.ptr.24 = getelementptr inbounds %t.app_state, ptr %field.base.24, i32 0, i32 1
  %r24 = ptrtoint ptr %field.ptr.24 to i64
  %copy.dst.24 = inttoptr i64 %r24 to ptr
  %copy.src.22 = inttoptr i64 %r22 to ptr
  %copy.val.24 = load %t.sg_pipeline, ptr %copy.src.22
  store %t.sg_pipeline %copy.val.24, ptr %copy.dst.24
  ret void
}
...
entry:
  ...
  %r0 = load i64, ptr %local0
  store i64 %r0, ptr %local1
  %call.struct.1 = call %t.sg_swapchain @"sglue_swapchain"()
  %call.ret.ptr.1 = alloca %t.sg_swapchain
  store %t.sg_swapchain %call.struct.1, ptr %call.ret.ptr.1
  %r1 = ptrtoint ptr %call.ret.ptr.1 to i64
  %r2 = ptrtoint ptr %local2 to i64
  %field.base.3 = inttoptr i64 %r2 to ptr
  %field.ptr.3 = getelementptr inbounds %t.sg_pass, ptr %field.base.3, i32 0, i32 4
  %r3 = ptrtoint ptr %field.ptr.3 to i64
  %copy.dst.3 = inttoptr i64 %r3 to ptr
  %copy.src.1 = inttoptr i64 %r1 to ptr
  %copy.val.3 = load %t.sg_swapchain, ptr %copy.src.1
  store %t.sg_swapchain %copy.val.3, ptr %copy.dst.3
  %r4 = ptrtoint ptr %local2 to i64
  %call.arg.75.0 = inttoptr i64 %r4 to ptr
  call void @"sg_begin_pass"(ptr %call.arg.75.0)
  %r5 = add i64 0, 0
  %r6 = add i64 0, 0
  %r7 = load i64, ptr %local1
  %field.base.8 = inttoptr i64 %r7 to ptr
  %field.ptr.8 = getelementptr inbounds %t.app_state, ptr %field.base.8, i32 0, i32 2
  %r8 = ptrtoint ptr %field.ptr.8 to i64
  ...
  %field.base.11 = inttoptr i64 %r10 to ptr
  %field.ptr.11 = getelementptr inbounds %t.app_state, ptr %field.base.11, i32 0, i32 3
  %r11 = ptrtoint ptr %field.ptr.11 to i64
  %load.ptr.12 = inttoptr i64 %r11 to ptr
  %load.raw.12 = load i32, ptr %load.ptr.12
  %r12 = sext i32 %load.raw.12 to i64
  %r13 = add i1 0, 1
  %call.arg.73.0 = trunc i64 %r5 to i32
  %call.arg.73.1 = trunc i64 %r6 to i32
  %call.arg.73.2 = trunc i64 %r9 to i32
  ...
  %field.ptr.15 = getelementptr inbounds %t.app_state, ptr %field.base.15, i32 0, i32 1
...
entry:
  ...
  %field.base.2 = inttoptr i64 %r1 to ptr
  %field.ptr.2 = getelementptr inbounds %t.sapp_event, ptr %field.base.2, i32 0, i32 15
  %r2 = ptrtoint ptr %field.ptr.2 to i64
